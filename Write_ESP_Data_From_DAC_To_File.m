...
[Data.Iteration, Data.ADC_ADS1115_0, Data.ADC_GPIO34, Data.Voltage_Bridge_ADS, Data.Voltage_Bridge_GPIO34,...
...
for i=1:Length_Data
    ...
    if length(commas)==6
        ...
        Data.Voltage_Bridge_ADS(i) = str2double(RetrieveData(commas(3):commas(4)-1));
