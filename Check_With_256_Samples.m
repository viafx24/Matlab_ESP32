...
[Data.Iteration,Data.Diff_1]=deal(zeros(1,Length_Data));
...
for i=1:Length_Data
    ...
    while length(commas) ~= 1
        commas = strfind(RetrieveData,',');
    end
    if length(commas)==1
        
        Data.Iteration(i) = str2double(RetrieveData(1:commas(1)-1));      
        Data.Diff_1(i) = str2double(RetrieveData(commas(1):end));
...
%     h2.YData=Data.ADC_GPIO34(1:i);
    h3.XData=Data.Iteration(1:i);
    h3.YData=Data.Diff_1(1:i);
%     h4.XData=1:i;
...
%     h6.YData=Data.Voltage_Corrected_GPIO34(1:i);
 ...
 %   save('Decharge_Batterie_powerbank_15000.mat','Data');
end