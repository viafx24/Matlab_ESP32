...
for i=1: 4095 % length(Data.ADC_GPIO34_Interp)
    
    if Data.ADC_GPIO34_Interp(i)==0
        fprintf(fileID,formatSpec,220);% aime of 220 is to signal a problem
    ...
    if  i <= Choice_Limit
        ...
        if Data.ADC_GPIO34_Interp(i)==i
            ...
            if i < (Choice_Limit-1) && (Data.ADC_GPIO34_Interp(i)>=Data.ADC_GPIO34_Interp(i+1)  )
                ...
                fprintf(fileID,formatSpec,(Data.Voltage_Bridge_ADS_Interp(i)+ Data.Voltage_Bridge_ADS_Interp(i+1))/2);
                ...
                fprintf(fileID,formatSpec,Data.Voltage_Bridge_ADS_Interp(i));
            end
            
            
        elseif  Data.ADC_GPIO34_Interp(i)>i
            
            fprintf(fileID,formatSpec,(Data.Voltage_Bridge_ADS_Interp(i-1) + Data.Voltage_Bridge_ADS_Interp(i))/2);
